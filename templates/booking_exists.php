...
<p>Es besteht bereits eine Buchung auf den Namen <strong><?php echo $this->_['booking']['givenname'] ?> <?php echo $this->_['booking']['name'] ?></strong> für die Veranstaltung <b>"<?php echo $this->_['event']->name ?>"</b> am <?php echo date("d.m.Y" , strtotime($this->_['event']->from)) ?><?php echo (date("H:i" , strtotime($this->_['event']->from)) == "00:00") ? "." : " " . date("H:i" , strtotime($this->_['event']->from)) . " Uhr." ?></p>
